...
import es.eriktorr.katas.config.FtpServerConfig
import net.ceedubs.ficus.Ficus._
import net.ceedubs.ficus.readers.ArbitraryTypeReader._

final case class ApplicationContext(ftpServerConfig: FtpServerConfig, ftpUsers: Seq[FtpUser])
...
object ApplicationContextLoader {
  def loadApplicationContext: ApplicationContext = {
    ...
    ApplicationContext(ftpServerConfig, ftpUsers)
  }
}
